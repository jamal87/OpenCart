		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="col-sm-6" id="quick-register">
					...
					<div class="form-group required">
						<label class="control-label" for="input-type"><?php echo $entry_type; ?></label><br>
						<label><input type="radio" name="type" value="user" id="input-type" checked />&nbsp;<?php echo $type_user; ?></label><br>
						<label><input type="radio" name="type" value="company" id="input-type" />&nbsp;<?php echo $type_company; ?></label>
					</div>					
					<div class="form-group required">
					...
					<div class="form-group required">
						<label class="control-label" for="input-reply-password"><?php echo $entry_reply_password; ?></label>
						<input type="password" name="reply-password" value="" id="input-reply-password" class="form-control" />
					</div>
					<?php if ($text_agree) { ?>
					<div class="buttons">
...
$('#quick-register .createaccount').click(function() {
	$.ajax({
		...
		type: 'post',
		data: $('#quick-register input[type=\'radio\'], #quick-register input[type=\'text\'], #quick-register input[type=\'password\'], #quick-register input[type=\'checkbox\']:checked'),
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			if (json['error_reply_password']) {
				$('#quick-register #input-reply-password').parent().addClass('has-error');
				$('#quick-register #input-reply-password').focus();
			}
			if (json['error']) {
