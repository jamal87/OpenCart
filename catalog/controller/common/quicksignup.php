...
class ControllerCommonQuicksignup extends Controller {
	public function index() {
		...
		$data['type_user'] = $this->language->get('type_user');
		$data['type_company'] = $this->language->get('type_company');
		$data['entry_name'] = $this->language->get('entry_name');
		$data['entry_email'] = $this->language->get('entry_email');
		$data['entry_telephone'] = $this->language->get('entry_telephone');
		$data['entry_password'] = $this->language->get('entry_password');
		$data['entry_reply_password'] = $this->language->get('entry_reply_password');
	...
	public function register() {
		...
		if ($this->customer->isLogged()) {
			...
			if ((utf8_strlen($this->request->post['reply-password']) < 4) || (utf8_strlen($this->request->post['reply-password']) > 20) || ($this->request->post['reply-password'] != $this->request->post['password'])) {
				$json['error'] = $json['error_reply_password'] = $this->language->get('error_reply_password');
			}
