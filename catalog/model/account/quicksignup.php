...
class ModelAccountQuicksignup extends Model {
	public function addCustomer($data) {
		...
		$customer_id = $this->db->getLastId();
                ...
                $this->load->model('account/customer_type');
                
                $customer_type_id = $this->model_account_customer_type->getCustomerTypeId($customer_type_sign);

		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_type SET customer_id = '" . (int)$customer_id . "', customer_type_id = '" . (int)$customer_type_id . "'");
